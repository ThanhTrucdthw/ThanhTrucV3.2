...
-- Source được seller khanhhuy2044 bán
-- Source thường là không thay đổi nên khi script không lên một là do bạn skid ngu,hai là do link trong source bị thay đổi và sẽ không hoàn

local Update = loadstring(Game:HttpGet"https://roblox.relzscript.xyz/source/relzhub/library/pc.lua")()
local Alert = loadstring(Game:HttpGet"https://raw.githubusercontent.com/ThanhTrucdthw/alert.txt.lua/main/alert.lua.txt")()
...
Main:Label("Script By tkahn trusc")
Main:Button("Copy Discord Link",function()
setclipboard("https://discord.com/invite/EMVK5NS9ys") 
end)
